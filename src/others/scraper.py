...
url = " /penalolen-metropolitana?tp=1&op=1&ca=2&ts=1&dd=0&dh=6&bd=0&bh=6&or=&mn=2&sf=1&sp=0&pd=9.000&ph=12.000"
browser.get(url)
#
...
print(profile)
filename = 'freportalinmobiliario.csv'
#writer = pd.ExcelWriter(filename, engine='xlsxwriter')
profile.csv(filename, index=False)
#writer.save()